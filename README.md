...
See [STR_TREE.md](https://github.com/bocke/pexports/blob/master/STR_TREE.md) for the details on str_tree.c/h binary search tree implementation used in pexports. Auto generated by Copilot with the help of Claude Sonnet 4.5.
